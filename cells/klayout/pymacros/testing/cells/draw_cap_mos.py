...
def draw_cap_nmos(layout, l, w ,volt, deepnwell, pcmpgr):
    ...
    cell_index  = layout.add_cell("cap_nmos")
    cap_nmos_cell = layout.cell(cell_index)
    ...
    # Inserting diffusion
    cap_nmos_cell.shapes(comp).insert(pya.Box(0, 0, cmp_w, cmp_l))
    cap_nmos_cell.shapes(nplus).insert(pya.Box(-implant_cmp_enc, -poly_ext, cmp_w+implant_cmp_enc, cmp_l+poly_ext))

    # Inserting poly
    cap_nmos_cell.shapes(poly).insert(pya.Box(cmp_poly_enc, -poly_ext, cmp_w-cmp_poly_enc, cmp_l+poly_ext))

    # Inserting left metal
    cap_nmos_cell.shapes(metal1).insert(pya.Box(-metal_cmp_ext_x, -metal_cmp_ext_y, -metal_cmp_ext_x+met_width, cmp_l))

    # Inserting right metal
    cap_nmos_cell.shapes(metal1).insert(pya.Box(cmp_w+metal_cmp_ext_x-met_width, -metal_cmp_ext_y, cmp_w+metal_cmp_ext_x, cmp_l))

    # Inserting poly metal
    cap_nmos_cell.shapes(metal1).insert(pya.Box(cmp_poly_enc+poly_met_enc_x, -poly_ext+poly_met_enc_y, cmp_w-cmp_poly_enc-poly_met_enc_x , cmp_l+poly_ext-poly_met_enc_y))
    ...
    cap_nmos_cell.insert(left_con_arr)
    ...
    cap_nmos_cell.insert(right_con_arr)
    ...
    cap_nmos_cell.insert(bot_con_arr)
    ...
    if deepnwell == True:
        ...
        cap_nmos_cell.shapes(comp).insert(cmp_gr)
        cap_nmos_cell.shapes(metal1).insert(cmp_gr)
        ...
        cap_nmos_cell.shapes(pplus).insert(pp_gr)
        ...
        # Inserting lvpwell
        cap_nmos_cell.shapes(lvpwell).insert(pya.Box(-pcmp2ncmp_spc-gr_w-lvpwell_enc_pcmp, -ply2gr_spc-poly_ext-gr_w-lvpwell_enc_pcmp, cmp_w+pcmp2ncmp_spc+gr_w+lvpwell_enc_pcmp, cmp_l+poly_ext+gr_w+lvpwell_enc_pcmp+ply2gr_spc))

        cap_nmos_cell.shapes(dnwell).insert(pya.Box(-pcmp2ncmp_spc-gr_w-lvpwell_enc_pcmp-dnwell_enc_lvpwell, -ply2gr_spc-poly_ext-gr_w-lvpwell_enc_pcmp-dnwell_enc_lvpwell, cmp_w+pcmp2ncmp_spc+gr_w+lvpwell_enc_pcmp+dnwell_enc_lvpwell, cmp_l+poly_ext+gr_w+lvpwell_enc_pcmp+dnwell_enc_lvpwell+ply2gr_spc))

    else:
        # Inserting lvpwell
        cap_nmos_cell.shapes(lvpwell).insert(pya.Box(0, 0, cmp_w, cmp_l))

        # Inserting bottom metal
        cap_nmos_cell.shapes(metal1).insert(pya.Box(-metal_cmp_ext_x, -metal_cmp_ext_y-met_width, cmp_w+metal_cmp_ext_x, -metal_cmp_ext_y))


    if volt == "5/6V":
        # Inserting dualgate
        if deepnwell == True:
            cap_nmos_cell.shapes(dualgate).insert(pya.Box(-pcmp2ncmp_spc-gr_w-lvpwell_enc_pcmp-dnwell_enc_lvpwell-dg_enc_dnwell, -ply2gr_spc-poly_ext-gr_w-lvpwell_enc_pcmp-dnwell_enc_lvpwell-dg_enc_dnwell, cmp_w+pcmp2ncmp_spc+gr_w+lvpwell_enc_pcmp+dnwell_enc_lvpwell+dg_enc_dnwell, cmp_l+poly_ext+pcmp2ncmp_spc+gr_w+lvpwell_enc_pcmp+dnwell_enc_lvpwell+dg_enc_dnwell))
        else:
            cap_nmos_cell.shapes(dualgate).insert(pya.Box(-dual_gate_cmp_enc_x, -dual_gate_cmp_enc_y, cmp_w+dual_gate_cmp_enc_x, cmp_l+dual_gate_cmp_enc_y))


    cap_nmos_cell.flatten(True)
...
def draw_cap_pmos(layout, l, w , volt, deepnwell, pcmpgr):
    ...
    # Inserting cap_pmos cell
    cell_index  = layout.add_cell("cap_pmos")
    cap_pmos_cell = layout.cell(cell_index)
    ...
    # Inserting diffusion
    cap_pmos_cell.shapes(comp).insert(pya.Box(0, 0, cmp_w, cmp_l))
    cap_pmos_cell.shapes(pplus).insert(pya.Box(-implant_cmp_enc, -poly_ext, cmp_w+implant_cmp_enc, cmp_l+poly_ext))

    # Inserting poly
    cap_pmos_cell.shapes(poly).insert(pya.Box(cmp_poly_enc, -poly_ext, cmp_w-cmp_poly_enc, cmp_l+poly_ext))

    # Inserting left cmp metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(-ncmp_pcmp_spc-gr_width, 0 , -metal_cmp_ext_x+met_width, cmp_l))

    # Inserting right cmp metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(cmp_w+metal_cmp_ext_x-met_width, 0, cmp_w+ncmp_pcmp_spc+gr_width, cmp_l))

    # Inserting top cmp metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(cmp_poly_enc+poly_met_enc_x, cmp_l+cmp_met_spc , cmp_w-cmp_poly_enc-poly_met_enc_x , cmp_l+poly_ext-poly_met_enc_y))

    # Inserting bottom cmp metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(cmp_poly_enc+poly_met_enc_x, -poly_ext+poly_met_enc_y, cmp_w-cmp_poly_enc-poly_met_enc_x , -cmp_met_spc))
    ...
    left_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_left_con_1, num_left_con_2)
    cap_pmos_cell.insert(left_con_arr)
    ...
    right_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_right_con_1, num_right_con_2)
    cap_pmos_cell.insert(right_con_arr)
    ...
    top_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_top_con_1, num_top_con_2)
    cap_pmos_cell.insert(top_con_arr)
    ...
    bot_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_bot_con_1, num_bot_con_2)
    cap_pmos_cell.insert(bot_con_arr)

    # Inserting left GR diff
    cap_pmos_cell.shapes(comp).insert(pya.Box(-ncmp_pcmp_spc-gr_width, -poly_ext-poly_ncmp_spc , -ncmp_pcmp_spc , cmp_l+poly_ext+poly_ncmp_spc))
    cap_pmos_cell.shapes(nplus).insert(pya.Box(-ncmp_pcmp_spc-gr_width-implant_cmp_enc, -poly_ext-poly_ncmp_spc+implant_cmp_enc , -ncmp_pcmp_spc+implant_cmp_enc , cmp_l+poly_ext+poly_ncmp_spc-implant_cmp_enc))
    # Inserting right GR diff
    cap_pmos_cell.shapes(comp).insert(pya.Box(cmp_w+ncmp_pcmp_spc, -poly_ext-poly_ncmp_spc , cmp_w+ncmp_pcmp_spc+gr_width , cmp_l+poly_ext+poly_ncmp_spc))
    cap_pmos_cell.shapes(nplus).insert(pya.Box(cmp_w+ncmp_pcmp_spc-implant_cmp_enc, -poly_ext-poly_ncmp_spc+implant_cmp_enc , cmp_w+ncmp_pcmp_spc+gr_width+implant_cmp_enc , cmp_l+poly_ext+poly_ncmp_spc-implant_cmp_enc))
    # Inserting top GR diff
    cap_pmos_cell.shapes(comp).insert(pya.Box(-ncmp_pcmp_spc-gr_width, cmp_l+poly_ext+poly_ncmp_spc , cmp_w+ncmp_pcmp_spc+gr_width , cmp_l+poly_ext+poly_ncmp_spc+gr_width))
    cap_pmos_cell.shapes(nplus).insert(pya.Box(-ncmp_pcmp_spc-gr_width-implant_cmp_enc, cmp_l+poly_ext+poly_ncmp_spc-implant_cmp_enc , cmp_w+ncmp_pcmp_spc+gr_width+implant_cmp_enc , cmp_l+poly_ext+poly_ncmp_spc+gr_width+implant_cmp_enc))
    # Inserting bottom GR diff
    cap_pmos_cell.shapes(comp).insert(pya.Box(-ncmp_pcmp_spc-gr_width, -poly_ext-poly_ncmp_spc-gr_width , cmp_w+ncmp_pcmp_spc+gr_width , -poly_ext-poly_ncmp_spc))
    cap_pmos_cell.shapes(nplus).insert(pya.Box(-ncmp_pcmp_spc-gr_width-implant_cmp_enc, -poly_ext-poly_ncmp_spc-gr_width-implant_cmp_enc , cmp_w+ncmp_pcmp_spc+gr_width+implant_cmp_enc , -poly_ext-poly_ncmp_spc+implant_cmp_enc))

    # Inserting left GR metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(-ncmp_pcmp_spc-gr_width, -poly_ext-poly_ncmp_spc , -ncmp_pcmp_spc , cmp_l+poly_ext+poly_ncmp_spc))
    # Inserting right GR metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(cmp_w+ncmp_pcmp_spc, -poly_ext-poly_ncmp_spc , cmp_w+ncmp_pcmp_spc+gr_width , cmp_l+poly_ext+poly_ncmp_spc))
    # Inserting top GR metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(-ncmp_pcmp_spc-gr_width, cmp_l+poly_ext+poly_ncmp_spc , cmp_w+ncmp_pcmp_spc+gr_width , cmp_l+poly_ext+poly_ncmp_spc+gr_width))
    # Inserting bottom GR metal
    cap_pmos_cell.shapes(metal1).insert(pya.Box(-ncmp_pcmp_spc-gr_width, -poly_ext-poly_ncmp_spc-gr_width , cmp_w+ncmp_pcmp_spc+gr_width , -poly_ext-poly_ncmp_spc))
    ...
    cap_pmos_cell.insert(gr_left_con_arr)
    ...
    cap_pmos_cell.insert(gr_right_con_arr)
    ...
    cap_pmos_cell.insert(gr_top_con_arr)
    ...
    if deepnwell == True:
        # Inserting dnwell
        cap_pmos_cell.shapes(dnwell).insert(pya.Box(-ncmp_pcmp_spc-gr_width-dnwell_enc_ncmp, -poly_ext-poly_ncmp_spc-gr_width-dnwell_enc_ncmp, cmp_w+ncmp_pcmp_spc+gr_width+dnwell_enc_ncmp , cmp_l+poly_ext+poly_ncmp_spc+gr_width+dnwell_enc_ncmp))
        ...
        if pcmpgr == True:
            ...
            cmp_gr = pya.Region(cmp_outer) - pya.Region(cmp_inner)
            cap_pmos_cell.shapes(comp).insert(cmp_gr)
            ...
            pp_gr = pya.Region(pp_outer) - pya.Region(pp_inner)
            cap_pmos_cell.shapes(pplus).insert(pp_gr)

    else:
        # Inserting nwell
        cap_pmos_cell.shapes(nwell).insert(pya.Box(-ncmp_pcmp_spc-gr_width-nwell_cmp_enc, -poly_ext-poly_ncmp_spc-gr_width-nwell_cmp_enc, cmp_w+ncmp_pcmp_spc+gr_width+nwell_cmp_enc , cmp_l+poly_ext+poly_ncmp_spc+gr_width+nwell_cmp_enc))

    if volt == "5/6V":
        # Inserting dualgate
        if deepnwell == True:
            cap_pmos_cell.shapes(dualgate).insert(pya.Box(-ncmp_pcmp_spc-gr_width-dnwell_enc_ncmp-dg_enc_dnwell, -poly_ext-poly_ncmp_spc-gr_width-dnwell_enc_ncmp-dg_enc_dnwell, cmp_w+ncmp_pcmp_spc+gr_width+dnwell_enc_ncmp+dg_enc_dnwell, cmp_l+poly_ext+poly_ncmp_spc+gr_width+dnwell_enc_ncmp+dg_enc_dnwell))
        else:
            cap_pmos_cell.shapes(dualgate).insert(pya.Box(-dual_gate_cmp_enc_x, -dual_gate_cmp_enc_y, cmp_w+dual_gate_cmp_enc_x, cmp_l+dual_gate_cmp_enc_y))

    cap_pmos_cell.flatten(True)
...
def draw_cap_nmos_b(layout, l, w , volt):
    ...
    # Inserting cap_nmos cell
    cell_index  = layout.add_cell("cap_nmos_b")
    cap_nmos_b_cell = layout.cell(cell_index)
    ...
    # Inserting diffusion
    cap_nmos_b_cell.shapes(comp).insert(pya.Box(0, 0, cmp_w, cmp_l))
    cap_nmos_b_cell.shapes(nplus).insert(pya.Box(-nwell_cmp_enc_x, -nwell_cmp_enc_y, cmp_w+nwell_cmp_enc_x, cmp_l+nwell_cmp_enc_y))

    # Inserting nwell
    cap_nmos_b_cell.shapes(nwell).insert(pya.Box(-nwell_cmp_enc_x, -nwell_cmp_enc_y, cmp_w+nwell_cmp_enc_x, cmp_l+nwell_cmp_enc_y))

    # Inserting poly
    cap_nmos_b_cell.shapes(poly).insert(pya.Box(cmp_poly_enc, -poly_ext, cmp_w-cmp_poly_enc, cmp_l+poly_ext))

    # Inserting extra poly
    cap_nmos_b_cell.shapes(poly).insert(pya.Box(cmp_poly_enc+poly_extra_in, cmp_l+poly_ext, cmp_w-cmp_poly_enc-poly_extra_in, cmp_l+poly_ext+poly_extra_out))  #top
    cap_nmos_b_cell.shapes(poly).insert(pya.Box(cmp_poly_enc+poly_extra_in, -poly_ext-poly_extra_out, cmp_w-cmp_poly_enc-poly_extra_in, -poly_ext))            #bot

    # Inserting left metal
    cap_nmos_b_cell.shapes(metal1).insert(pya.Box(-metal_cmp_ext_x, -metal_cmp_ext_y, -metal_cmp_ext_x+met_width, cmp_l))

    # Inserting right metal
    cap_nmos_b_cell.shapes(metal1).insert(pya.Box(cmp_w+metal_cmp_ext_x-met_width, -metal_cmp_ext_y-met_width, cmp_w+metal_cmp_ext_x, cmp_l))

    # Inserting bottom metal
    cap_nmos_b_cell.shapes(metal1).insert(pya.Box(-metal_cmp_ext_x, -metal_cmp_ext_y-met_width, cmp_w+metal_cmp_ext_x, -metal_cmp_ext_y))

    # Inserting poly metal
    cap_nmos_b_cell.shapes(metal1).insert(pya.Box(cmp_poly_enc+poly_extra_in, -poly_ext-poly_extra_out, cmp_w-cmp_poly_enc-poly_extra_in, cmp_l+poly_ext+poly_extra_out))
    ...
    left_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_left_con_1, num_left_con_2)
    cap_nmos_b_cell.insert(left_con_arr)
    ...
    right_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_right_con_1, num_right_con_2)
    cap_nmos_b_cell.insert(right_con_arr)
    ...
    top_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_top_con_1, num_top_con_2)
    cap_nmos_b_cell.insert(top_con_arr)
    ...
    bot_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_bot_con_1, num_bot_con_2)
    cap_nmos_b_cell.insert(bot_con_arr)

    # Inserting marker
    cap_nmos_b_cell.shapes(mos_cap_mk).insert(pya.Box(0, 0, cmp_w, cmp_l))

    if volt == "5/6V":
        # Inserting dualgate
        cap_nmos_b_cell.shapes(dualgate).insert(pya.Box(-dualgate_cmp_enc_x, -dualgate_cmp_enc_y, cmp_w+dualgate_cmp_enc_x, cmp_l+dualgate_cmp_enc_y))



    cap_nmos_b_cell.flatten(True)
...
def draw_cap_pmos_b(layout, l, w , volt):
    ...
    # Inserting cap_pmos cell
    cell_index  = layout.add_cell("cap_pmos_b")
    cap_pmos_b_cell = layout.cell(cell_index)
    ...
    # Inserting diffusion
    cap_pmos_b_cell.shapes(comp).insert(pya.Box(0, 0, cmp_w, cmp_l))
    cap_pmos_b_cell.shapes(pplus).insert(pya.Box(-nwell_cmp_enc_x, -nwell_cmp_enc_y, cmp_w+nwell_cmp_enc_x, cmp_l+nwell_cmp_enc_y))

    # Inserting poly
    cap_pmos_b_cell.shapes(poly).insert(pya.Box(cmp_poly_enc, -poly_ext, cmp_w-cmp_poly_enc, cmp_l+poly_ext))

    # Inserting extra poly
    cap_pmos_b_cell.shapes(poly).insert(pya.Box(cmp_poly_enc+poly_extra_in, cmp_l+poly_ext, cmp_w-cmp_poly_enc-poly_extra_in, cmp_l+poly_ext+poly_extra_out))  #top
    cap_pmos_b_cell.shapes(poly).insert(pya.Box(cmp_poly_enc+poly_extra_in, -poly_ext-poly_extra_out, cmp_w-cmp_poly_enc-poly_extra_in, -poly_ext))            #bot

    # Inserting left metal
    cap_pmos_b_cell.shapes(metal1).insert(pya.Box(-metal_cmp_ext_x, -metal_cmp_ext_y, -metal_cmp_ext_x+met_width, cmp_l))

    # Inserting right metal
    cap_pmos_b_cell.shapes(metal1).insert(pya.Box(cmp_w+metal_cmp_ext_x-met_width, -metal_cmp_ext_y-met_width, cmp_w+metal_cmp_ext_x, cmp_l))

    # Inserting bottom metal
    cap_pmos_b_cell.shapes(metal1).insert(pya.Box(-metal_cmp_ext_x, -metal_cmp_ext_y-met_width, cmp_w+metal_cmp_ext_x, -metal_cmp_ext_y))

    # Inserting poly metal
    cap_pmos_b_cell.shapes(metal1).insert(pya.Box(cmp_poly_enc+poly_extra_in, -poly_ext-poly_extra_out, cmp_w-cmp_poly_enc-poly_extra_in, cmp_l+poly_ext+poly_extra_out))
    ...
    left_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_left_con_1, num_left_con_2)
    cap_pmos_b_cell.insert(left_con_arr)
    ...
    right_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_right_con_1, num_right_con_2)
    cap_pmos_b_cell.insert(right_con_arr)
    ...
    top_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_top_con_1, num_top_con_2)
    cap_pmos_b_cell.insert(top_con_arr)
    ...
    bot_con_arr = pya.CellInstArray(cont_cell.cell_index(), pya.Trans(
        ...
        pya.Vector(cont_min_spc + cont_size, 0), pya.Vector(0,cont_min_spc + cont_size),
        num_bot_con_1, num_bot_con_2)
    cap_pmos_b_cell.insert(bot_con_arr)

    # Inserting marker
    cap_pmos_b_cell.shapes(mos_cap_mk).insert(pya.Box(0, 0, cmp_w, cmp_l))

    if volt == "5/6V":
        # Inserting dualgate
        cap_pmos_b_cell.shapes(dualgate).insert(pya.Box(-dualgate_cmp_enc_x, -dualgate_cmp_enc_y, cmp_w+dualgate_cmp_enc_x, cmp_l+dualgate_cmp_enc_y))


    cap_pmos_b_cell.flatten(True)
    return cap_pmos_b_cell
