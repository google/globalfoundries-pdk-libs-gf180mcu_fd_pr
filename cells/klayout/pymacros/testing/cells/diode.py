...
class diode_np(pya.PCellDeclarationHelper):
    ...
    def produce_impl(self):
        np_instance = draw_diode_np(self.layout, self.l, self.w , self.volt, self.deepnwell, self.pcmpgr)
...
class diode_pn(pya.PCellDeclarationHelper):
    ...
    def produce_impl(self):
        np_instance = draw_diode_pn(self.layout, self.l, self.w ,self.volt, self.deepnwell, self.pcmpgr)
        write_cells = pya.CellInstArray(np_instance.cell_index(), pya.Trans(pya.Point(0, 0)),
                      pya.Vector(0, 0), pya.Vector(0, 0), 1, 1)
