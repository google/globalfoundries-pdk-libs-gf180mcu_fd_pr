...
C {test_nmos_3p3.sym} 190 -410 0 0 {name=x1}
C {test_nmos_3p3_sab.sym} 190 -360 0 0 {name=x2}
C {test_pmos_3p3.sym} 190 -310 0 0 {name=x3}
C {test_pmos_3p3_sab.sym} 190 -260 0 0 {name=x4}
...
C {test_nmos_6p0.sym} 190 -210 0 0 {name=x5}
C {test_pmos_6p0.sym} 190 -160 0 0 {name=x6}
C {test_nmos_6p0_nat.sym} 190 -110 0 0 {name=x7}
C {test_nplus_u.sym} 1550 -360 0 0 {name=x8}
C {devices/launcher.sym} 90 -790 0 0 {name=h2
descr="Gitlab"
url="https://gitlab.com"}
C {test_nmoscap_3p3.sym} 530 -260 0 0 {name=x9}
C {test_pmoscap_3p3.sym} 530 -210 0 0 {name=x10}
C {test_pplus_u.sym} 1550 -310 0 0 {name=x11}
C {test_vnpn_10x10.sym} 870 -110 0 0 {name=x12}
C {test_vpnp_10x10.sym} 870 -160 0 0 {name=x13}
C {test_np_3p3.sym} 1210 -110 0 0 {name=x14}
C {test_nwell.sym} 1550 -110 0 0 {name=x15}
C {test_npolyf_u.sym} 1550 -210 0 0 {name=x16}
C {test_ppolyf_u.sym} 1550 -160 0 0 {name=x17}
C {test_nmoscap_6p0.sym} 530 -110 0 0 {name=x18}
C {test_nmoscap_3p3.sym} 530 -260 0 0 {name=x19}
C {test_pmoscap_6p0.sym} 530 -160 0 0 {name=x20}
C {test_dnwpw.sym} 1210 -160 0 0 {name=x21}
C {test_rm1.sym} 1550 -260 0 0 {name=x22}
C {test_mim_2p0fF.sym} 530 -310 0 0 {name=x23}
